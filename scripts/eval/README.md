...
variant labels in `suggestion-popup.js`, and editing a suggestion in
`editor.js`. The editor tests run on `tests/js/fixtures/two_sentences.json`,
real backend output regenerated by `make_two_sentences.py` next to it.
