...
def call_model(user_prompt: str) -> str:
    """One completion. Endpoint/model/auth come from _probe_endpoint, so this
    probe can be pointed at another provider without editing code."""
    import httpx
